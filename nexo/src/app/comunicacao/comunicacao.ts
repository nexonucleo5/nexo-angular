...
export class Comunicacao implements OnInit {
  ...
  mensagens = [
    {
      ...
      historico: [
        ...
        { remetente: 'professor', texto: 'Olá Ana! Vou explicar novamente. O crescimento exponencial ocorre quando...', data: 'Hoje 14:45' }
      ]
    },
    {
      id: 2,
      ...
      historico: [
        { remetente: 'aluno', texto: 'Gostaria de revisar a questão 3 da prova...', data: 'Hoje 12:15' }
      ]
    },
    {
      id: 3,
      ...
      historico: [
        { remetente: 'aluno', texto: 'Obrigada pelo material extra!', data: 'Ontem 16:45' }
      ]
    }
  ];
  ...
  avisos = [
    { titulo: 'Prova Bimestral - Próxima Semana', conteudo: 'A prova bimestral de Matemática será aplicada na próxima segunda-feira, 10 de junho, às 14h. Estudem os capítulos 5 a 8.', horario: 'Hoje 09:00', turmas: ['2º Ano A', '2º Ano B'], vistos: 28, total: 32 },
    { titulo: 'Aula de Reforço - Trigonometria', conteudo: 'Aula extra de trigonometria na quinta-feira, 13/06, às 16h na sala 204. Participação opcional.', horario: 'Ontem 15:30', turmas: ['2º Ano C'], vistos: 22, total: 35 }
  ];

  duvidas = [
    { aluno: 'Daniel Santos', tempo: 'Há 2 horas', status: 'Pendente', pergunta: 'Como resolver sistemas lineares com 3 variáveis?', materia: 'Matemática', avatar: 'https://i.pravatar.cc/150?img=12' },
    { aluno: 'Eduarda Ferreira', tempo: 'Há 4 hours', status: 'Respondida', pergunta: 'Qual a diferença entre velocidade média e instantânea?', materia: 'Física', avatar: 'https://i.pravatar.cc/150?img=26' }
  ];
  ...
  alunos = [
    {
      ...
      historico: [
        ...
        { activity: 'Prova de Trigonometria', data: '27 Mai', nota: '8.5' },
  ...
  alunosFiltrados() {
    return this.alunos.filter(a => 
      ...
      (a.nome.toLowerCase().includes(this.buscaAluno.toLowerCase()) || a.matricula.includes(this.buscaAluno))
    );
  }
