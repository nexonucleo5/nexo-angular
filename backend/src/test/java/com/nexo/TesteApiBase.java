...
// O segredo do JWT não tem default em lugar nenhum da aplicação: em produção ele vem
// do ambiente, e subir sem ele é falha proposital. O teste então fornece o seu, em vez
// de reintroduzir uma chave versionada no application.yml só para o contexto arrancar.
// As subclasses acrescentam as próprias propriedades (o nome do banco), sem substituir
// esta — @TestPropertySource é herdado e mesclado.
@TestPropertySource(properties = "nexo.jwt.secret=segredo-de-teste-com-mais-de-32-caracteres-abcdef")
